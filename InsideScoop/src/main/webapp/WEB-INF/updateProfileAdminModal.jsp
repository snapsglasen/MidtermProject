...
<div class="modal fade" id="updateProfileAdminModal" tabindex="-1" aria-labelledby="updateProfileAdminModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    <!-- Modal header - Make sure to change the "id" property pf the "modal-title" div -->
      <div class="modal-header">
        <h5 class="modal-title" id="updateProfileAdminModalLabel">Update Profile</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <!-- Modal body - Replace internal components with regular HTML/CSS -->
      <div class="modal-body">
      	<!-- BEGIN REPLACE COMPONENTS -->
      	<form action="updateProfileAttemptAdmin.do" method="GET">
